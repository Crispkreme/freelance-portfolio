            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-16">
                    ...
                    <div className={`space-y-8 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
                        <h3 className="text-2xl font-bold text-white mb-16">Contact Information</h3>
                        ...
                        <div className="space-y-4">
                            {contacts.map((contact, contactIndex) => {
                                ...
                                return (
                                    <div
                                        key={contactIndex}
                                        className={`flex items-center gap-4 p-4 bg-slate-900 rounded-lg hover:bg-slate-700 transition-all duration-300 border border-slate-700 hover:border-green-500 group cursor-pointer transform hover:scale-105 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                                        style={{ transitionDelay: `${contactIndex * 200 + 300}ms` }}
                                    >
                        ...
                        <div className={`pt-8 transition-all duration-1000 delay-900 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
                            ...
                            <div className="flex gap-4">
                                {[Icons.Github, Icons.Linkedin, Icons.Facebook].map((Icon, index) => (
                                    <a
                                        key={index}
                                        className="w-12 h-12 bg-slate-900 text-gray-300 rounded-lg flex items-center justify-center hover:bg-green-600 hover:text-white transition-all duration-300 group border border-slate-700 hover:border-green-500 hover:scale-110 hover:rotate-6"
                                    >
